...
def staat(qq):
  ...
  data = {
    ...
    "caption": "Get instant access to Corona in Sri Lanka 📊 .  Automatically retrieve the latest corona information after adding it to the @janithsbots Group 🦠 . Developer @janith_sadanuwan.  ",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
...
async def help(event):
    await event.respond('This Is Covid 19 Update Bot🇱🇰 Developer - @janith_sadanuwan 🎭Use the /corona command to view the latest corona news👻 ')
    raise events.StopPropagation
